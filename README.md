...
## Function ScientSDI()
Helps the users to verify if the SPI and SPEI calculated from NASA POWER data meet the conceptual assumptions expected from standardized drought indices.
